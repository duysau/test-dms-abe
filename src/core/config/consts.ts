...
export const STANDARD_DATE_FORMAT_HAVE_CLOCK = "DD/MM/YYYY HH:mm:ss";
export const STANDARD_DATE_FORMAT_COMPACT_WITH_TIME = "DDMMYYYY HHmm";
...
export const NOT_TAB_ENTER_REGEX_REPLACE = /[\t\n\r]/g;
 ...
 * route constants
 */
export const FORBIDDEN_ROUTE = join(ROOT_ROUTE + "/403");
export const NOT_FOUND_ROUTE = join(ROOT_ROUTE + "/404");
export const LOGIN_ROUTE = join(ROOT_ROUTE + "/login");
export const LOGOUT_ROUTE = join(ROOT_ROUTE + "/logout");
...
export const MODAL_WIDTH_600 = 600;
...
// Dolla unit
export const USD_CURRENCY_UNIT = "USD";
...
export const CODE_DASHBOARD = "HOME";

export const PURCHASE_PLAN_MENU_CODE = "PURCHASE_PLAN";

export const BUDGET_MENU_CODE = "PKG";

export const PAYMENT_MENU_CODE = "PAYMENT";
